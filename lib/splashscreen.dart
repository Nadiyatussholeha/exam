...
import 'package:examnadiyatus/registrasi.dart';
        ...
        body: Stack(
          children: <Widget>[
            ...
            Positioned(
              ...
              left: 105,
              child: Image.asset(
                'splash.png', // Ganti dengan path gambar Anda
                width: 200,
                height: 150,
              ),
            ),
            ...
            Positioned(
              top: 550,
              left: 130,
              child: Text('Gets things with TODs', style: TextStyle(fontWeight: FontWeight.bold),),
            ),
